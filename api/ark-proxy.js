// Vercel Serverless Function: 通用 Ark 代理
// 使用方式：
// POST https://<your-vercel-domain>/api/ark-proxy?path=/images/generations
// Body 为原始 Ark 接口 JSON；本函数会在服务端附加 Authorization，并转发响应。
